...
// Set the points at which each variable starts since all of this is part of a single vector
...
class FG_eval {
 public:
  ...
  // Setup constraints, add 1 to the starting indices due to
  ...
  //The rest of the constraints, verify all values
  ...
  for ( t = 0; t < N - 1; t++) {
    ...
    //Fixed equation as suggested in second review
...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) {
  ...
  //move code to main.cpp as suggested by reviewer
  //double dt = 0.1;
